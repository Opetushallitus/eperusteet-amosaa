namespace Revisions {
    ...
    export const parseAll = (revisions: Array<any>) => [parseOne(_.first(revisions)), _.map(revisions, parseOne)];

    export const get = (revisions: Array<any>, id: number) => _(revisions).find(rev => rev.id === id);
}
