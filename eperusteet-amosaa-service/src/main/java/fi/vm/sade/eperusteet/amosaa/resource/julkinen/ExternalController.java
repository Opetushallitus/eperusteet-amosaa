...
public class ExternalController {
    ...
    @Parameters({
            ...
            @Parameter(name = "sivukoko", schema = @Schema(implementation = Long.class, defaultValue = "10"), in = ParameterIn.QUERY, description = "Sivutus: yhdellä sivulla palautettavien tulosten määrä. Oletusarvo 10."),
