...
public class TuvaOpetussuunnitelmaPerustePaivitysService extends MuutOpetussuunnitelmaPerustePaivitysService {
    ...
    public void paivitaOpetussuunnitelma(Long opetussuunnitelmaId, PerusteKaikkiDto perusteKaikkiDto) {
        ...
        koulutuksenosatViite.setLapset(new ArrayList<>(
                CollectionUtil.treeToStream(opetussuunnitelma.getSisaltoviitteet(), SisaltoViite::getLapset)
                    ...
                    .peek(koulutuksenosaViite -> {
                        koulutuksenosaViite.getVanhempi().getLapset().remove(koulutuksenosaViite);
        ...
        sisaltoviiteRepository.save(koulutuksenosatViite);
    }
}
