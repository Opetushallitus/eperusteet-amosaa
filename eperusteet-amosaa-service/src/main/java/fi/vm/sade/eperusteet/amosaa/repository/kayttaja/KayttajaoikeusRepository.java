...
//    @Query("SELECT o.oikeus FROM Kayttajaoikeus o WHERE o.kayttaja.id = ?1 AND o.koulutustoimija.id = ?2 AND o.ops = NULL")
...
//    @Query("SELECT o.oikeus FROM Kayttajaoikeus o WHERE o.koulutustoimija.id = ?1 AND o.ops.id = ?2")
//    KayttajaoikeusTyyppi findKayttajaoikeusOpetussuunnitelma(Long kayttaja, Long ops);

//    @Query("SELECT o FROM Kayttajaoikeus o WHERE o.koulutustoimija.id = ?1 AND o.ops = NULL")
    @Query("SELECT o FROM Kayttajaoikeus o WHERE o.koulutustoimija.id = ?1")
    List<Kayttajaoikeus> findAllYhteiset(Long koulutustoimija);
...
//    List<Kayttajaoikeus> findAllByOps(Opetussuunnitelma ops);
}
