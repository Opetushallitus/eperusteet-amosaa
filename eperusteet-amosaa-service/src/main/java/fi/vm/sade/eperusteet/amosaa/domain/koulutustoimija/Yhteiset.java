...
@Audited
@Table(name = "yhteiset")
public class Yhteiset extends AbstractAuditedEntity implements Serializable, ReferenceableEntity {
    @Id
    ...
    @Audited(targetAuditMode = RelationTargetAuditMode.NOT_AUDITED)
    @JoinTable(name = "yhteiset_liite", inverseJoinColumns = {@JoinColumn(name="liite_id")}, joinColumns = {@JoinColumn(name="yhteiset_id")})
    @Getter
    @Setter
