...
@Service
@Transactional
public class KotoOpintoSisaltoviiteServiceImpl implements SisaltoViiteToteutusService {
    ...
    public SisaltoTyyppi getSisaltoTyyppi() {
        return SisaltoTyyppi.KOTO_OPINTO;
    }

    @Override
    public SisaltoViite updateSisaltoViite(SisaltoViite viite, SisaltoViiteDto uusi) {
        KotoOpinto uusiKotoOpinto = mapper.map(uusi.getKotoOpinto(), KotoOpinto.class);
        viite.setKotoOpinto(uusiKotoOpinto);
        return viite;
    }
}
