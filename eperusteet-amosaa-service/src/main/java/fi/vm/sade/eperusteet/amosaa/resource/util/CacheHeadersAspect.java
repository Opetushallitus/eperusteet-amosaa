...
public class CacheHeadersAspect {
    ...
    @Pointcut("execution(org.springframework.http.ResponseEntity fi.vm.sade.eperusteet.amosaa.resource..*Controller.*(..))")
    public void controller() {
    }

    @Around("controller() && !@annotation(fi.vm.sade.eperusteet.amosaa.resource.util.CacheControl)")
