alter table omaosaalue drop constraint FK_6fg0v6lj0dvlp0fgruo7f8r5s;
alter table omaosaalue drop constraint FK_52a1u39n74b6kja9jcesr5ja3;
...
alter table omaosaalue
    add column geneerinenarviointi int8;
alter table omaosaalue_aud
    add column geneerinenarviointi int8;

alter table omatutkinnonosa
    add column geneerinenarviointi int8;
alter table omatutkinnonosa_aud
    add column geneerinenarviointi int8;
...
create table ammattitaitovaatimukset2019_ammattitaitovaatimus (
    ...
    primary key (ammattitaitovaatimukset_id, jarjestys)
);
...
create table ammattitaitovaatimukset2019_ammattitaitovaatimus_AUD (
    ...
    REVTYPE int2,
    REVEND int4,
    primary key (REV, ammattitaitovaatimukset_id, ammattitaitovaatimus_id, jarjestys)
);
...
create table ammattitaitovaatimukset2019_kohdealue_AUD (
    ...
    REVTYPE int2,
    REVEND int4,
    primary key (REV, ammattitaitovaatimukset_id, kohdealue_id, jarjestys)
);
...
create table ammattitaitovaatimus2019kohdealue_ammattitaitovaatimus (
    ...
    ammattitaitovaatimus_id int8 not null,
    jarjestys int4 not null,
    primary key (kohdealue_id, jarjestys)
);
...
create table ammattitaitovaatimus2019kohdealue_ammattitaitovaatimus_AUD (
    ...
    REVTYPE int2,
    REVEND int4,
    primary key (REV, kohdealue_id, ammattitaitovaatimus_id, jarjestys)
);
...
alter table omatutkinnonosa
    add column ammattitaitovaatimukset_id int8
    references ammattitaitovaatimukset2019;
