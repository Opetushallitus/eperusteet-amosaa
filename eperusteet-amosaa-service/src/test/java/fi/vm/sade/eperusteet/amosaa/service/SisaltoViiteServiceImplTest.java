...
public class SisaltoViiteServiceImplTest {
    ...
    private final List<UUID> rakennemoduulitunnisteet = Arrays.asList(UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID(),
            UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID());
    private final List<UUID> rakennemoduulitunnisteetPiilotetut = Arrays.asList(rakennemoduulitunnisteet.get(1),
