...
public class KayttooikeusServiceMock implements KayttooikeusService{
    ...
    private static Map<String, List<KayttoikeusKayttajaDto>> kayttoikeuskayttajaMap() {
        return ImmutableMap.of(
                AbstractIntegrationTest.oidKp1, Arrays.asList(
                        KayttoikeusKayttajaDto.builder()
                ...
                AbstractIntegrationTest.oidKp2, Arrays.asList(
                        ...
                        KayttoikeusKayttajaDto.builder()
                            ...
                            .sukunimi("kp1sukunimi")
                            .build()),
                AbstractIntegrationTest.oidTmpr, Arrays.asList(KayttoikeusKayttajaDto.builder()
